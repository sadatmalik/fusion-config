...
# Add Maintainer Info
LABEL maintainer="Sadat Malik <sadat.malik@creativefusion.net>"
...
# Execute the application - targets the fusion service in the image when the
# container is created
ENTRYPOINT ["java","-cp","app:app/lib/*","com.sadatmalik.fusionconfig.FusionConfigApplication"]

# Execute the following terminal command to build the docker image
